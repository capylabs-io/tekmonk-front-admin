...
export const postCertificate = async (data: any) => {
  const response = await tekdojoAxios.post(`${BASE_URL}/certificates`, {
    data,
  });
...
export const getCertificate = async (query: string = "") => {
  const response = await tekdojoAxios.get(`${BASE_URL}/certificates?${query}`);
  return response.data;
};

export const updateCertificate = async (id: number, data: any) => {
  const response = await tekdojoAxios.put(`${BASE_URL}/certificates/${id}`, {
    data,
  });
  return response.data;
};
...
export const postCertificateHistory = async (data: any) => {
  const response = await tekdojoAxios.post(
    `${BASE_URL}/certificate-histories`,
    { data }
  );
  return response.data;
};
...
export const postCertificatePdfConfig = async (data: any) => {
  const response = await tekdojoAxios.post(
    `${BASE_URL}/certificate-pdf-configs`,
    data,
    {
      headers: {
...
export const getCertificatePdfConfig = async (query: string = "") => {
  const response = await tekdojoAxios.get(
    `${BASE_URL}/certificate-pdf-configs?${query}`
  );
  return response.data;
};
...
export const updateCertificatePdfConfig = async (id: number, data: any) => {
  const response = await tekdojoAxios.put(
    `${BASE_URL}/certificate-pdf-configs/${id}`,
    data,
    {
      headers: {
        "Content-Type": "multipart/form-data",
...
export const postCertificatePdfConfigField = async (data: any) => {
  const response = await tekdojoAxios.post(
    `${BASE_URL}/certificate-pdf-field-configs`,
    { data }
  );
  return response.data;
};
...
export const getCertificatePdfConfigField = async (query: string = "") => {
  const response = await tekdojoAxios.get(
    `${BASE_URL}/certificate-pdf-field-configs?${query}`
  );
  return response.data;
};

export const updateCertificatePdfConfigField = async (
  id: number,
  data: any
) => {
  const response = await tekdojoAxios.put(
    `${BASE_URL}/certificate-pdf-field-configs/${id}`,
    { data }
  );
  return response.data;
};
