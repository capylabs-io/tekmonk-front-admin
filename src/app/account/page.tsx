...
export default function Account() {
  ...
  return (
    <>
      <div className="text-xl text-primary-900 px-8">Thông tin tài khoản</div>
      ...
      <div className="border rounded-xl border-gray-200 mx-8 w-2/3 grid grid-cols-5 p-4">
        <div className="col-span-2 my-auto">
          <div className="text-SubheadSm !font-normal">Ảnh đại diện</div>
      ...
      <div className="border rounded-xl border-gray-200 mx-8 w-2/3 p-4 mt-4">
        <div className="grid grid-cols-5">
          <div className="col-span-2 my-auto">
            <div className="text-SubheadSm !font-normal">Tên thành viên</div>
          </div>
        ...
        <div className="grid grid-cols-5 mt-4">
          <div className="col-span-2 my-auto">
            <div className="text-SubheadSm !font-normal">Số điện thoại</div>
          </div>
          <div className="col-span-3">
            <Input
              type="text"
        ...
        <div className="grid grid-cols-5 mt-4">
          <div className="col-span-2 my-auto">
            <div className="text-SubheadSm !font-normal">Địa chỉ</div>
          </div>
          <div className="col-span-3">
            <Input
              type="text"
        ...
        <div className="grid grid-cols-5 mt-4">
          <div className="col-span-2 my-auto">
            <div className="text-SubheadSm !font-normal">Mật khẩu</div>
          </div>
          <div className="col-span-3">
            <Input
              type="password"
        ...
        <div className="w-full flex justify-end mt-4">
          <Dialog>
            <DialogTrigger
              ...
              className="bg-transparent !text-primary-600 text-SubheadSm !p-0"
            >
              Đổi mật khẩu
            </DialogTrigger>
            <DialogContent className="sm:max-w-md">
              ...
              <div className="w-full px-8">
                ...
                <Input
                  ...
                  customInputClassNames="text-sm"
                />
                <div className="mt-3 text-sm">Nhập lại mật khẩu mới:</div>
                <Input
                  type="password"
                  customClassNames="mt-2"
