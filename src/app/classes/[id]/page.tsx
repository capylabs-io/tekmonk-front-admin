        ...
        <>
            ...
            <Tabs defaultValue="info" className="mt-5 px-8">
                <TabsList className="rounded-t-xl">
                    <TabsTrigger value="info" className="rounded-tl-xl border-r border-gray-300">Thông tin chung</TabsTrigger>
                    <TabsTrigger value="student" className="border-r border-gray-300">Học viên</TabsTrigger>
                    <TabsTrigger value="misson" className="border-r border-gray-300">Nhiệm vụ</TabsTrigger>
                    <TabsTrigger value="progress" className="rounded-tr-xl">Tiến trình</TabsTrigger>
                </TabsList>
                <TabsContent value="info" className="overflow-y-auto text-sm p-4 border border-gray-300 rounded-b-xl rounded-tr-xl w-2/3">
                ...
                <TabsContent value="student" className="overflow-y-auto text-sm p-4 border border-gray-300 rounded-b-xl rounded-tr-xl">
                    <div className="w-full flex justify-between items-center">
                        ...
                        <div className="flex gap-x-6 items-center">
                            <div className="text-primary-950 text-sm">Tổng số: {LeaderboardMock.length} học viên</div>
                            <Dialog>
                                <DialogTrigger>
                                ...
                                <DialogContent className="sm:min-w-md">
                                    <div className="w-full text-center text-SubheadLg text-primary-900">Thêm học sinh</div>
                ...
                <TabsContent value="misson" className="overflow-y-auto text-sm p-4 border border-gray-300 rounded-b-xl rounded-tr-xl">
                </TabsContent>
                <TabsContent value="progress" className="overflow-y-auto text-sm p-4 border border-gray-300 rounded-b-xl rounded-tr-xl"></TabsContent>
            </Tabs>
        </>
    );
}
